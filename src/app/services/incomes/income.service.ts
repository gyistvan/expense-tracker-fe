...
import { Income, IncomePayload, IncomeResponse } from './interfaces/income';
...
export class IncomeService {
  ...
  public getIncomeById(id: string): Observable<Income> {
    return this.http.get<Income>(BASE_URL + apiUrls.INCOME.GET + id);
  }

  public updateIncomeById(
    id: string,
    incomePayload: IncomePayload
  ): Observable<IncomeResponse> {
    return this.http.put<IncomeResponse>(
      BASE_URL + apiUrls.INCOME.UPDATE + id,
      incomePayload
    );
  }
}
